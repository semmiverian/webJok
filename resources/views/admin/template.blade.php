<!DOCTYPE html>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="index2.html" class="logo"><b>Admin</b>JOK</a>
          ...
          <span class="input-group-btn">
            <button type='submit' name='search' id='search-btn' class="btn btn-flat"><i class="fa fa-search"></i></button>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active"><a href="{{action('adminController@index')}}"> <i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                    <li><a href="{{action('userControl@index')}}"><i class="fa  fa-user"></i><span>User Access </span></a></li>
                    <li class="treeview">
                        <a href="#"><i class="fa fa-home"></i><span>CMS</span> <i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="{{action('slideController@index')}}"><i class="fa fa-picture-o"> SlideShow </i></a> </li>
                            <li><a href="{{action('bannerController@index')}}"><i class="fa fa-picture-o"> Banner </i></a> </li>
